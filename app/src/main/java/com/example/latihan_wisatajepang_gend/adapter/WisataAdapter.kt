package com.example.latihan_wisatajepang_gend.adapter
...
import com.example.latihan_wisatajepang_gend.MainActivity
import com.example.latihan_wisatajepang_gend.R
import com.example.latihan_wisatajepang_gend.model.WisataModel
import com.example.latihan_wisatajepang_gend.screen_splash
    ...
    RecyclerView.Adapter<WisataAdapter.MyViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: WisataAdapter.MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            ...
            val intent = Intent(getActivity, screen_splash::class.java)
